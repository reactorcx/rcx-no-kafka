...
module.exports = (function () {
    ...
    exports.ConsumerGroup = require('./consumer_group');
    exports.GroupAdmin = require('./group_admin');
    exports.ShareConsumer = require('./share_consumer');
    ...
    exports.COMPRESSION_LZ4 = 3;
    exports.COMPRESSION_ZSTD = 4;
    exports.COMPRESSION_NONE = 0;

    // share group acknowledgement types (KIP-932)
    exports.ACKNOWLEDGE_TYPE = require('./share_consumer').ACKNOWLEDGE_TYPE;

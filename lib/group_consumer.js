...
GroupConsumer.prototype._joinGroup = function () {
    ...
    return (function _tryJoinGroup(attempt) {
        ...
        return self.client.joinConsumerGroupRequest(self.options.groupId, self.memberId, self.options.sessionTimeout, _.values(self.strategies).map(function (s) {
...
GroupConsumer.prototype._syncGroup = function () {
    ...
    .then(function (result) {
        var ownerMap, assignments, assignedIds;
        ...
        if (self._cooperative && self.members) {
            assignedIds = _.map(assignments, 'memberId');
            _.each(self.members, function (member) {
...
GroupConsumer.prototype._updateSubscriptionsCooperative = function (partitionAssignment, handler) {
    ...
    _.each(self.ownedPartitions, function (tp) {
        _.each(tp.partitions, function (p) {
            var key = tp.topic + ':' + p;
            if (!newSet[key]) {

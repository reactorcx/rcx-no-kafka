...
Protocol.define('JoinConsumerGroupResponse_Member', {
    read: function () {
        ...
        if (_subLength > 0) {
            ...
            // skip trailing fields from newer ConsumerProtocolSubscription versions
            // (v2 generationId, v3 rackId) so the next member parses correctly
            if ((this.offset - _startOffset) < _subLength) {
                this.skip(_subLength - (this.offset - _startOffset));
            }
        }
    }
});
...
Protocol.define('JoinConsumerGroupResponse_MemberV5', {
    read: function () {
        ...
        if (_subLength > 0) {
            ...
            // skip trailing v2+ ConsumerProtocolSubscription fields
            if ((this.offset - _startOffset) < _subLength) {
                this.skip(_subLength - (this.offset - _startOffset));
            }
        }
...
Protocol.define('JoinConsumerGroupRequestV6_GroupProtocolItem', {
    write: function (data) {
        ...
        bodyBuf = Buffer.allocUnsafe(bodyLen);
...
Protocol.define('JoinConsumerGroupResponse_MemberV6', {
    read: function () {
        ...
        if (this.context._subLength > 1) {
            ...
            // skip trailing v2+ ConsumerProtocolSubscription fields
            if ((this.offset - _startOffset) < n) {
                this.skip(n - (this.offset - _startOffset));
            }
        }
        this.TaggedFields();
    }
...
// JoinGroup v7 response — adds ProtocolType between generationId and groupProtocol
Protocol.define('JoinConsumerGroupResponseV7', {
    read: function () {
        this
            .Int32BE('correlationId')
            .TaggedFields()
            ...
            .ErrorCode('error')
            .Int32BE('generationId')
            .compactNullableString('protocolType')
            .compactString('groupProtocol')
            .compactString('leaderId')
            .compactString('memberId')
            .compactArray('members', this.JoinConsumerGroupResponse_MemberV6)
...
// JoinGroup v9 response — adds SkipAssignment between leaderId and memberId (on top of v7)
Protocol.define('JoinConsumerGroupResponseV9', {
    read: function () {
        this
            .Int32BE('correlationId')
            .TaggedFields()
...
// JoinGroup v7 — wire-identical to v6, just apiVersion bump
Protocol.define('JoinConsumerGroupRequestV7', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.JoinGroupRequest,
...
// JoinGroup v8 (KIP-800) — adds Reason after protocols array
Protocol.define('JoinConsumerGroupRequestV8', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.JoinGroupRequest,
            ...
            .compactString('consumer')
            .compactArray(data.groupProtocols, this.JoinConsumerGroupRequestV6_GroupProtocolItem)
            .compactNullableString(data.reason || null)
            .TaggedFields();
    }
});

// JoinGroup v9 — wire-identical to v8
Protocol.define('JoinConsumerGroupRequestV9', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.JoinGroupRequest,
...
Protocol.define('SyncConsumerGroupRequestV4_GroupAssignment', {
    write: function (data) {
        ...
        if (!data.memberAssignment ||
            ...
            // SyncGroup Assignment is NOT nullable in the spec — encode empty bytes
            this.compactBytes(Buffer.alloc(0));
        } else {
...
// SyncGroup v5 (KIP-559) — adds protocolType and protocolName to request
// SyncGroup v5 response — adds ProtocolType and ProtocolName between error and memberAssignment
Protocol.define('SyncConsumerGroupResponseV5', {
    read: function () {
        this
            .Int32BE('correlationId')
            .TaggedFields()
            ...
            .ErrorCode('error')
            .compactNullableString('protocolType')
            .compactNullableString('protocolName')
            .SyncConsumerGroupResponseV4_MemberAssignment('memberAssignment')
            .TaggedFields();
    }
});

Protocol.define('SyncConsumerGroupRequestV5', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.SyncGroupRequest,
            ...
            .compactString(data.memberId)
            .compactNullableString(data.groupInstanceId || null)
            .compactNullableString(data.protocolType || null)
            .compactNullableString(data.protocolName || null)
            .compactArray(data.groupAssignment, this.SyncConsumerGroupRequestV4_GroupAssignment)
            .TaggedFields();
    }
});
...
// LeaveGroup v5 (KIP-800) — adds reason per member; response same as v4
Protocol.define('LeaveGroupRequestV5_MemberItem', {
    write: function (data) {
        this
            .compactString(data.memberId || '')
            .compactNullableString(data.groupInstanceId || null)
...
Protocol.define('LeaveGroupRequestV5', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.LeaveGroupRequest,
            ...
            .compactString(data.groupId)
            .compactArray(data.members, this.LeaveGroupRequestV5_MemberItem)
            .TaggedFields();
    }
});

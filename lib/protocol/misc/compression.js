...
Snappy = snappy ? {
    ...
    _uncompressAsync: _snappyPromise ? _.ary(snappy.uncompress, 1) : _.ary(Promise.promisify(snappy.uncompress), 1),
    ...
    compressAsync: _snappyPromise ? _.ary(snappy.compress, 1) : _.ary(Promise.promisify(snappy.compress), 1)
} : undefined;

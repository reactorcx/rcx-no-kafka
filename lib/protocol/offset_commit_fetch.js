...
Protocol.define('OffsetCommitRequestV2', {
    write: function (data) { // { groupId, generationId, memberId, retentionTime, topics }
        this
            ...
            .Int32BE(data.generationId)
            .string(data.memberId)
            .Int64BE(data.retentionTime !== undefined ? data.retentionTime : -1)
...
// OffsetCommit v9 (KIP-848) — wire-identical to v8
Protocol.define('OffsetCommitRequestV9', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.OffsetCommitRequest,
...
// OffsetCommit v10 (KIP-848) — replaces topic Name with TopicId (uuid)
Protocol.define('OffsetCommitRequestV10PartitionItem', {
    write: function (data) {
        this
            .Int32BE(data.partition)
            .Int64BE(data.offset)
...
Protocol.define('OffsetCommitRequestV10TopicItem', {
    write: function (data) {
        this
            .uuid(data.topicId)
            .compactArray(data.partitions, this.OffsetCommitRequestV10PartitionItem)
            .TaggedFields();
    }
});

Protocol.define('OffsetCommitRequestV10', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.OffsetCommitRequest,
            ...
            .compactString(data.memberId)
            .compactNullableString(data.groupInstanceId || null)
            .compactArray(data.topics, this.OffsetCommitRequestV10TopicItem)
            .TaggedFields();
    }
});

Protocol.define('OffsetCommitResponseV10PartitionItem', {
    read: function () {
        this
            .Int32BE('partition')
            .ErrorCode('error')
...
Protocol.define('OffsetCommitResponseV10TopicItem', {
    read: function () {
        this
            .uuid('topicId')
            .compactArray('partitions', this.OffsetCommitResponseV10PartitionItem)
            .TaggedFields();
    }
});

Protocol.define('OffsetCommitResponseV10', {
    read: function () {
        this
            .Int32BE('correlationId')
            .TaggedFields()
            .Int32BE('throttleTime')
            .compactArray('topics', this.OffsetCommitResponseV10TopicItem)
            .TaggedFields();
    }
});
...
// OffsetFetch v10 (KIP-848) — replaces topic Name with TopicId (uuid) in groups→topics
Protocol.define('OffsetFetchRequestV10_TopicItem', {
    write: function (data) {
        this
            .uuid(data.topicId)
            .compactArray(data.partitions, this.Int32BE)
...
Protocol.define('OffsetFetchRequestV10_GroupItem', {
    write: function (data) {
        this.compactString(data.groupId);
        this
            .compactNullableString(data.memberId || null)
        ...
        if (data.topics === null || data.topics === undefined) {
            ...
            this.compactArray(data.topics, this.OffsetFetchRequestV10_TopicItem);
        }
        this.TaggedFields();
    }
});

Protocol.define('OffsetFetchRequestV10', {
    write: function (data) {
        this
            .FlexibleRequestHeader({
                apiKey: globals.API_KEYS.OffsetFetchRequest,
            ...
            .compactArray(data.groups, this.OffsetFetchRequestV10_GroupItem)
            .Int8(data.requireStable ? 1 : 0)
            .TaggedFields();
    }
});

Protocol.define('OffsetFetchResponseV10PartitionItem', {
    read: function () {
        this
            .Int32BE('partition')
            .KafkaOffset('offset')
...
Protocol.define('OffsetFetchResponseV10TopicItem', {
    read: function () {
        this
            .uuid('topicId')
            .compactArray('partitions', this.OffsetFetchResponseV10PartitionItem)
            .TaggedFields();
    }
});

Protocol.define('OffsetFetchResponseV10_GroupItem', {
    read: function () {
        this
            .compactString('groupId')
            .compactArray('topics', this.OffsetFetchResponseV10TopicItem)
            .ErrorCode('error')
            .TaggedFields();
    }
});

Protocol.define('OffsetFetchResponseV10', {
    read: function () {
        this
            .Int32BE('correlationId')
            .TaggedFields()
            .Int32BE('throttleTime')
            .compactArray('groups', this.OffsetFetchResponseV10_GroupItem)
            .TaggedFields();
    }
});

...
Client.prototype._rebootstrap = function () {
    ...
    self.initialBrokers = _.compact(self.options.connectionString.split(',').map(function (hostStr) {
        ...
        .then(function (topics) {
            return Promise.all(_mapTopics(topics).map(function (r) {
                ...
                .then(function (newMessageSet) {
                    return _.assign({}, r, { messageSet: [].concat.apply([], newMessageSet) });
                });
            }));
        });
    });
...
Client.prototype._applyLeaderHints = function (topics, nodeEndpoints) {
    ...
    if (nodeEndpoints && nodeEndpoints.length) {
        _.each(nodeEndpoints, function (ep) {
            var remapped;
    ...
    _.each(topics, function (t) {
        ...
        _.each(t.partitions, function (p) {
